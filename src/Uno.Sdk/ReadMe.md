...
|----------------|:---------------:|
| UnoVersion* | 6.1.0-dev.543 |
| UnoExtensionsVersion | 5.4.0-dev.31 |
| UnoToolkitVersion | 7.1.0-dev.11 |
...
| WindowsCompatibilityVersion** | 8.0.16 |
| MicrosoftIdentityClientVersion | 4.72.1 |
