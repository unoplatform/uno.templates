...
|----------------|:---------------:|
| UnoVersion* | 6.7.0-dev.642 |
| UnoExtensionsVersion | 7.3.0-dev.94 |
...
| MicrosoftIdentityClientVersion | 4.85.1 |
