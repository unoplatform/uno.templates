...
| UnoToolkitVersion | 8.1.4 |
| UnoThemesVersion | 5.7.3 |
| UnoCSharpMarkupVersion | 6.2.10 |
...
>>>>>>> 3f42acb (chore: Pin Svg.Skia to 3.0.3 in templates/sdk to avoid breaking changes introduced with version ≥ 3.0.4)
