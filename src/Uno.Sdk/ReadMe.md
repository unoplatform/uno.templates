...
|----------------|:---------------:|
| UnoVersion* | 6.4.0-dev.357 |
| UnoExtensionsVersion | 6.3.0-dev.36 |
| UnoToolkitVersion | 8.3.0-dev.25 |
| UnoThemesVersion | 5.8.0-dev.9 |
...
| WinAppSdkVersion | 1.8.251003001 |
