...
|----------------|:---------------:|
| UnoVersion* | 6.6.0-dev.653 |
| UnoExtensionsVersion | 7.2.0-dev.32 |
| UnoToolkitVersion | 8.5.0-dev.29 |
| UnoThemesVersion | 7.0.0-dev.7 |
...
| UnoResizetizerVersion | 1.13.0-dev.11 |
...
| MicrosoftIdentityClientVersion | 4.83.0 |
