...
|----------------|:---------------:|
| UnoVersion* | 5.6.0-dev.477 |
| UnoExtensionsVersion | 5.2.0-dev.12 |
| UnoToolkitVersion | 6.4.0-dev.51 |
| UnoThemesVersion | 5.4.0-dev.18 |
...
| MicrosoftLoggingVersion** | 9.0.0 |
| WindowsCompatibilityVersion** | 9.0.0 |
