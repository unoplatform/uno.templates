...
|----------------|:---------------:|
| UnoVersion* | 7.0.0-dev.763 |
| UnoExtensionsVersion | 8.0.0-dev.7 |
| UnoToolkitVersion | 11.0.0-dev.3 |
| UnoThemesVersion | 9.0.0-dev.16 |
...
| MicrosoftIdentityClientVersion | 4.90.0 |
